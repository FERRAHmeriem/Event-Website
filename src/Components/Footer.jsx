    ...
    <div>
     <div className=" flex justify-between bg-footer p-16 border-b border-gold">
        ...
        <div className="flex gap-4">
           { !isLoggedIn && <Link to="/SignUp" className="bg-gold hover:bg-gold2  rounded-2xl font-medium pe-5 ps-5 h-8 flex items-center" ><p>Sign Up</p></Link>}
           { !isLoggedIn && <Link to="/Login" className="bg-white hover:bg-gray-200 rounded-2xl font-medium pe-6 ps-6 h-8 flex items-center" ><p>Log in</p></Link>}
        </div>
     </div>
