...
import YourEvents from '../Components/UserEvents';
...
export default function Profile () {
   ...
   const userInfo = {
        ...
        name : "Mohamed amine",
        imgUrl : UserIcon ,
        description : "hi am mohammed i wish you like my event hhhhh",
        email : "mohamed@gmail.com",
        number: "0667358203",
      };
    const following = [
        { id: 1, username: 'Meriem Ferrah ',imgUrl : UserIcon , isFollowed: false },
        ...
        <span className='flex justify-center h-rest gap-x-6'>
            <div className='mt-8'>
                <div className='h-80 w-[440px] rounded-lg p-4 px-6 border border-[#bdbdbd] bg-white'>
                    <div className='flex flex-col items-center justify-center mb-6'>
                        ...
                        <Link to={`/EditProfile/${id}`} className='bg-[#0047ff] flex justify-center text-white w-80 rounded-lg p-1 transition duration-300 ease-in-out hover:bg-blue-700'>Edit Profile</Link>
                    </div>
            ...
            <section className='flex-col w-1/2 mt-8'>
                <div className='h-[60px] rounded-lg p-2 flex items-center justify-evenly border border-[#bdbdbd] bg-white'>
                    ...
                    <a href="" className={` ${showEvents ? 'pt-[17px] pb-3 border-b-4 border-[#0047ff]' : ''}`} onClick={handleEventsClick}>Your Events</a>
                ...
                {showEvents && <YourEvents isUser= {true}/>}
